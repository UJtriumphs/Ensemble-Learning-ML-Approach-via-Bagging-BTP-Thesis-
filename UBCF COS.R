...
check <- read.csv("C:/Users/ashish_pc/Desktop/BTP mod/UBCF1 FIL.csv")
for(i in 1:16000)
{
...
recd=Recommender(r[1:nrow(r)],method="UBCF", param=list(normalize = "Z-score",method="Cosine",nn=5, minRating=1))
print(recd)
names(getModel(recd))
